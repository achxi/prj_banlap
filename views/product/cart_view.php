...
if(isset($_POST['update']))
{
    if(!isset($_POST['soluong'])){
        redirect($base_url.'product/cart.html');
        exit();
    }else{
...
?>
    <form action="<?php echo $base_url;?>product/cart.html" method="post">
        <div id='product'>
               <div id='cart'>
                    <h3>GIỎ HÀNG</h3>
                    <div class="tinhtien">
        ...
        <?php
            if($data== 0){
                echo "<div>You haven't chosen any product yet.</div>";
                echo "<div><a href='".$base_url."index.html'>Continue shopping</a></div>";
            }else{
        ...
        ?>
             <div class="sanpham">&nbsp;</div>
                   ...
                   <div class="thanhtien"><span style="color:red; font-weight: bold"><?php if($data== 0){echo 0;}else{echo $tratien2;} ?></span></div>
